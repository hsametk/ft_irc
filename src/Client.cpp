...
Client::Client() 
    : _fd(-1), _nickname(""), _username(""),
     _realname(""), _passOk(false),_nickset(false),
      _userset(false), _registered(false), _buffer("") {}
...
Client::Client(const Client &other)
    : _fd(other._fd), _nickname(other._nickname), 
     _username(other._username), _realname(other._realname),
     _passOk(other._passOk), _nickset(other._nickset),
     _userset(other._userset), _registered(other._registered),
